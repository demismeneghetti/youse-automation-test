...
element :nasci_em_text, 'select#auto_order_flow_pricing_requirements_insured_person_attributes_date_of_birth'
...
element :proximo_passo_button, 'input#button.button--primary'
  ...
  def preenche_proposta_pricing_requirements(marca, modelo, ano, versao, uso, propriedade, disponibilidade, cep, sexo, data_nascimento, estado_civil, principal_condutor, cobertura_extra, sinistro)
    ...
    self.e_o_seu_uso_e_combo.select uso
    self.eu_posse_carro_combo.select propriedade
    self.e_uso_combo.select disponibilidade
