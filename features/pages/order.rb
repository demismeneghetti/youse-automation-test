...
element :mandar_um_email_para, 'input#auto_order_flow_lead_person_data_lead_person_attributes_email'
element :proximo_passo_button, 'input#button.button--primary'
  ...
  def preenche_proposta(nome, tipo, telefone, email)
    ...
    self.estou_fazendo_o_seguro_combo.set
    self.pode_me_ligar_text.set telefone
    self.mandar_um_email_para.set email
